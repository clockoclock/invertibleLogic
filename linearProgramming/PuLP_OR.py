...
# Created by: WHH
# Date: 2026-04-07
# Description: Ising 模型参数求解器 - OR 逻辑门
# 本代码实现了一个基于整数线性规划的 Ising 模型参数求解器，针对 OR 逻辑门设计。
...
def solve_ising_bipolar(logic_gate='OR', energy_gap=1):
...
solve_ising_bipolar(logic_gate='OR', energy_gap=2)